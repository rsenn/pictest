...
#define SET_CONFIGURATION_PARAMETER_SIZE(numint)                                                                       \
  (FIELD_OFFSET(SET_CONFIGURATION_PARAMETER, Interfaces) + numint * sizeof(SET_CONFIGURATION_PARAMETER::_Interfaces))
