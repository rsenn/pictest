...
;************** PLACE THE FOLLOWING CODE AT THE END OF THE USER-PROG
 ...
 IF DBRK==1	;DBUG16F: -- DEBUG INSIDER -- TARGET ROUTINE VR 1.0
...
DG007	BSF	STATUS,RP0	;SET RBANK1
	BSF	T		;SET INPUT PIN
	CLRF	STATUS		;SET RBANK0
	CALL	DG014		;WAIT INPUT CMD
	BTFSS	DB1,7		;CMD,7=0?
	GOTO	DG008		;YES, RD/WR CMD
	MOVLW	DBN
	BTFSC	DB1,4		;SEND SPEED?
	GOTO	DG013		;Y, SEND DBN VALUE
...
DG008	BTFSC	DB1,4
	...
	CALL	DG014		;WAIT INS-EEADR TO READ
...
DG009	MOVF	DB1,W
	...
	GOTO	DG011		;POINT TO W_TMP
	BTFSC	DB1,5		;IF STATUS SELECTED BY CMD
	GOTO	DG010		;POINT TO STATUS_TMP

	CALL	DG014		;ELSE, WAIT INPUT ADR -> DB1
	...
	BTFSS	STATUS,Z
	GOTO	$+3
DG010	MOVLW	DB2		;SET STATUS_TMP_ADR
	GOTO	DG011
	...
	BTFSC	FSR,0		;INS-ADRH=BANK2-3?
	BSF	STATUS,IRP	;SET BANK2-3
	MOVF	DB1,W		;INS-ADR -> W

DG011	BTFSS	FSR,6		;CMD,6=1?
	GOTO	DG012		;NO -> RD CMD
	MOVWF	FSR		;YES-> WR CMD, SET INS-ADR
	CALL	DG014		;WAIT INPUT INS-DATA
	MOVF	DB1,W
	MOVWF	INDF		;WRITE DATA
	GOTO	DG007		;GOTO INPUT CMD
DG012	MOVWF	FSR		;SET INS-ADR
...
DG014	CLRF	DB1		;INIT DBUG BYTE DB1
	BTFSC	X		;WAIT '0' SYNC
	GOTO	$-1
	GOTO	DG016
