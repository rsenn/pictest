...
**************PLACE THE FOLLOWING CODE AT THE END OF THE USER - PROG
                                                                    ...
                                                                    IF DBRK ==
    1;
12FDBUG : --DEBUG INSIDER-- TARGET ROUTINE VR 1.0 NOLIST DB0 EQU 5FH;
...
-----BE CAREFUL WITH OSCCAL / CONFIG BYTE AT THE END OF PROG -
    ...
    P CALL DG004 CALL DG002 BSF GPIO, P NOP INCFSZ FSR GOTO DG005 DG007 BSF STATUS, RP0 BSF TRISIO,
    P CLRF STATUS CALL DG014 BTFSS DB1, 7 GOTO DG008 MOVLW DBN BTFSC DB1, 4 GOTO DG013 MOVF DB3, W MOVWF FSR MOVF DB4,
    W MOVWF INTCON MOVF DB2, W MOVWF STATUS SWAPF DB0 SWAPF DB0, W RETURN DG008 BTFSC DB1, 4 BTFSS DB1,
    5 GOTO DG009 CALL DG014 IF DBEE IFDEF EECON1 BSF STATUS, RP0 MOVF EEADR, W MOVWF FSR MOVF DB1,
    W MOVWF EEADR MOVF EEDATA, W BSF EECON1, 0 XORWF EEDATA XORWF EEDATA, W XORWF EEDATA MOVWF DB1 MOVF FSR,
    ...
    Z GOTO $ + 3 MOVLW DB3 GOTO DG011 XORLW INTCON ^ FSR MOVLW DB4 BTFSS STATUS, Z MOVF DB1, W DG011 BTFSS FSR,
    6 GOTO DG012 MOVWF FSR CALL DG014 MOVF DB1, W MOVWF INDF GOTO DG007 DG012 MOVWF FSR MOVF INDF,
    W DG013 MOVWF DB1 GOTO DG001 DG014 CLRF DB1 BTFSC GPIO, P GOTO $ - 1 GOTO DG016 DG015 CLRW ADDLW 1 BTFSC GPIO,
    P GOTO $ - 2 ADDLW .256 - .96 / DBN RRF DB1 DG016 CLRW ADDLW 1 BTFSS GPIO,
    P GOTO $ - 2 ADDLW .256 - .96 / DBN RRF DB1 BTFSS STATUS, C GOTO DG015 RETURN LIST ENDIF
