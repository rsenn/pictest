...
void
ReadVersion(void) // TESTED: Passed
{
...
void
ReadProgMem(void) // TESTED: Passed
{
...
void
WriteProgMem(void) // TESTED: Passed
{
  /*
   * The write holding register for the 18F2550 family is
...
void
EraseProgMem(void) // TESTED: Passed
{
...
void
WriteConfig(void) // TESTED: Passed
{
