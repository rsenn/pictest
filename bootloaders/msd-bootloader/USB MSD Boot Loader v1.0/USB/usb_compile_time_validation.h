 ...
 * Ray Gordon			1/10/07		Added MSD definitions as per Microchip example
 ********************************************************************/
...
#error(MSD Out endpoint size cannot be bigger than 64, check "usbcfg.h")
#endif
#endif

#if defined(MSD_IN_EP_SIZE)
#if(MSD_IN_EP_SIZE > 64)
#error(MSD In endpoint size cannot be bigger than 64, check "usbcfg.h")
#endif
#endif
