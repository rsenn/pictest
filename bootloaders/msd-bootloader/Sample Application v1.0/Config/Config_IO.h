/*********************************************************************
 *
 *      Sample Application - I/O Configuration & Macros
 *
 *********************************************************************
 ...
 * Author           Date        	Comment
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * Ray Gordon       7/07/08	  		Original (for PICDEM FS)
...
#define Timer_Flag_1mS			PIR1bits.TMR2IF
								...
								/* Timer 2 will rollover every 1.024mS - Low Priority Interrupt */
#define mInitTimer_1mS()		OpenTimer2(TIMER_INT_ON & T2_PRESCALE & T2_POSTSCALE);\
								IPR1bits.TMR2IP = 0;\
								RCONbits.IPEN = 1;\
								INTCONbits.GIEL = 1;\
								INTCONbits.GIE = 1;	
