...
const uint8_t configDescriptor1[] = {
    ...
    0x20,
    0x01, // bcdCDC (CDC spec version this fw complies with: v1.20 [stored in little endian])
...
const struct {
  ...
  uint16_t string[1];
    ...
    sizeof(sd000), USB_DESCRIPTOR_STRING, {0x0409} // 0x0409 = Language ID code for US English
};
...
const struct {
  ...
  uint8_t bDscType;
  uint16_t string[25];
} sd001 = {sizeof(sd001), USB_DESCRIPTOR_STRING, {'M', 'i', 'c', 'r', 'o', 'c', 'h', 'i', 'p', ' ', 'T', 'e', 'c',
                                                  'h', 'n', 'o', 'l', 'o', 'g', 'y', ' ', 'I', 'n', 'c', '.'}};
...
const struct {
  ...
  uint8_t bDscType;
  uint16_t string[28];
} sd002 = {sizeof(sd002), USB_DESCRIPTOR_STRING, {'M', 'i', 'c', 'r', 'o', 'c', 'h', 'i', 'p', ' ', 'C', 'o', 'm',
                                                  'p', 'o', 's', 'i', 't', 'e', ' ', 'D', 'e', 'v', 'i', 'c', 'e'}};
...
const struct {
  ...
  uint8_t bDscType;
  uint16_t string[12];
} sd003 = {sizeof(sd003), USB_DESCRIPTOR_STRING, {'1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '9', '9'}};
