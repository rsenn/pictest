 ...
 *****************************************************************************/
uint8_t
DIRECT_MediaDetect(void* config) {
  return true;
} // end MediaDetect
 ...
 *****************************************************************************/
uint16_t
DIRECT_SectorSizeRead(void* config) {
 ...
 *****************************************************************************/
uint32_t
DIRECT_CapacityRead(void* config) {
...
DIRECT_MediaInitialize(void* config) {
 ...
 *****************************************************************************/
uint8_t
DIRECT_SectorRead(void* config, uint32_t sector_addr, uint8_t* buffer, uint8_t seg) {
  // Read a sector worth of data, and copy it to the specified RAM "buffer"
  if(0 == sector_addr)
    MasterBootRecordGet(buffer, seg);
  else if(1 == sector_addr)
    ...
    if(4 == sector_addr) {                // Service README.HTM
      if(seg < ((readme_size() + 63) % 64))
        strncpy((void*)buffer, (void*)&readme[seg * 64],
 ...
 *****************************************************************************/
uint8_t
DIRECT_SectorWrite(void* config, uint32_t sector_addr, uint8_t* buffer, uint8_t seg) {
 ...
 *****************************************************************************/
uint8_t
DIRECT_WriteProtectStateGet(void* config) {
  return false;
}
 ...
 */
bool
DIRECT_ProgrammingInProgress(void) {
  return app;
}
