...
Parameter::Parameter(unsigned int id, string argument, string value) : _id(id), _argument(argument), _value(value) {}
...
string
Parameter::argument() const {
  return _argument;
}

unsigned long
Parameter::ulongValue() const {
  string str = value();
  unsigned int val;
  char* endptr;
  errno = 0;
