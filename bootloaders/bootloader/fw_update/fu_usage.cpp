...
FUUsage::FUUsage() {
  add(UsageDescriptor(
      ARG_WRITE, "w", "write", UsageDescriptor::absent, "", "Write data to device.", UsageDescriptor::command));

  add(UsageDescriptor(
      ARG_READ, "r", "read", UsageDescriptor::absent, "", "Read data from device.", UsageDescriptor::command));

  add(UsageDescriptor(
      ARG_VERIFY, "v", "verify", UsageDescriptor::absent, "", "Verify device memory.", UsageDescriptor::command));

  add(UsageDescriptor(
      ARG_ERASE, "e", "erase", UsageDescriptor::absent, "", "Erase device memory.", UsageDescriptor::command));

  add(UsageDescriptor(ARG_VERSION,
                      "ver",
                      "version",
  ...
  add(UsageDescriptor(
      ARG_HELP, "h", "help", UsageDescriptor::absent, "", "Print this message.", UsageDescriptor::command));

  add(UsageDescriptor(ARG_MEM_TYPE,
                      "m",
                      "memory",
  ...
  add(UsageDescriptor(
      ARG_VID, "vid", "vendorid", UsageDescriptor::required, "VID", "Device vendor ID.", UsageDescriptor::option));

  add(UsageDescriptor(
      ARG_PID, "pid", "productid", UsageDescriptor::required, "PID", "Device product ID.", UsageDescriptor::option));

  add(UsageDescriptor(ARG_RESET,
                      "t",
                      "reset",
                      UsageDescriptor::required,
                      "YES | NO",
  ...
  add(UsageDescriptor(ARG_DATA_SIZE,
                      "s",
                      "size",
                      UsageDescriptor::required,
                      "SIZE",
  ...
  add(UsageDescriptor(ARG_IMAGE_DATA,
                      "d",
                      "data",
