...
#define FIRMWARE_VERSION                                                                                               \
  0x002428            // Firmware version is located here
...
#define FW_TOP_BLOCK_ADDRESS                                                                                           \
  FW_SIZE - 63 // Program memory address of final 64-byte block
...
#define KEY                                                                                                            \
  0xAA // Start key for basic encryption (user modifiable)
