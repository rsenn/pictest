...
#define PSDLENGTH	39
#define PSD		'U','S','B',' ','G','e','n','e','r','i','c',' ','H','I','D',' ','r','e','f','e','r','e','n','c','e',' ','b','o','a','r','d',' ','3','_','0','_','0','_','0'
...
// PIC to hardware pin mapping and control macros
	...
	#define mInitStatusLeds()	LATD &= 0xF0; TRISD &= 0xF0;
	...
	#define mInitStatusLeds()	LATB &= 0xF0; TRISB &= 0xF0;
