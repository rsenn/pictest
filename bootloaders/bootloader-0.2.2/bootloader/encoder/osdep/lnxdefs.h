...
CreateFileA(char* name, int flags, int, int, int crmode, int, int) {
  FILE* f;
  char m[4] = {0, 0, 0, 0};
...
static inline bool
WriteFile(HANDLE hFile, char* buf, unsigned long size, unsigned long* count, void*) {
  FILE* f = (FILE*)(hFile);
...
static inline void
CopyMemory(void* dst, void* src, unsigned long size) {
  memcpy(dst, src, size);
}
/*
