...
UsageDescriptor::UsageDescriptor(unsigned int id,
                                 string shortArgument,
                                 string verboseArgument,
                                 ValueRelevance valueRelevance,
                                 string valueAlias,
                                 string description,
                                 Type type,
                                 std::string defaultValue)
    : _id(id), _shortArgument(shortArgument), _verboseArgument(verboseArgument), _valueRelevance(valueRelevance),
      _valueAlias(valueAlias), _description(description), _type(type), _defaultValue(defaultValue) {
...
bool
UsageDescriptor::operator==(const unsigned int& id) const {
  return (id == _id);
}

string
UsageDescriptor::argument() const {
