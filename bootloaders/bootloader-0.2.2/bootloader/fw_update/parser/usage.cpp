...
void
Usage::add(const UsageDescriptor& descriptor) {
...
void
Usage::print(const list<UsageUpdate>& update) {
  cout << "COMMANDS:\n";
...
void
Usage::print(const list<UsageUpdate>& update, UsageDescriptor::Type type) {
