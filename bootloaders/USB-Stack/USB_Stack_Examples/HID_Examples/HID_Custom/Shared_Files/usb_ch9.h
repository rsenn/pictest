...
enum { Device = 0, Interface, Endpoint, Other };
...
enum { DEVICE_REMOTE_WAKEUP = 1, ENDPOINT_HALT = 0, TEST_MODE = 2 };

/// Test Mode Selectors
enum { Test_J = 1, Test_K, Test_SE0_NAK, Test_Packet, Test_Force_Enable };
