...
const uint8_t HID_Report_Descriptor[] = {Usage_Page2(VENDOR_DEFINED_PAGE),
                                         Usage(0x01),
...
volatile union { uint8_t Array[HID_IN_REPORT1_SIZE]; } In_Report1 = {0};
...
volatile struct { uint8_t Array[HID_OUT_REPORT1_SIZE]; } Out_Report1;
