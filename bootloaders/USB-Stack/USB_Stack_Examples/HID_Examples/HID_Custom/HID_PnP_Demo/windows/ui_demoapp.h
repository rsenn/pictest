...
public:
  ...
  void
  retranslateUi(QMainWindow* DemoApp) {
    ...
    deviceConnectedStatus->setText(
        QApplication::translate("DemoApp", "Device Not Detected: Verify Connection/Correct Firmware", nullptr));
  } // retranslateUi
};
