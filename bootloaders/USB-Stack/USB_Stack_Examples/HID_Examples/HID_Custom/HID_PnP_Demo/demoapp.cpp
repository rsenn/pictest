...
DemoApp::DemoApp(QWidget* parent) : QMainWindow(parent), ui(new Ui::DemoApp) {
  ui->setupUi(this);
...
void
DemoApp::on_pushButton_clicked() {
  emit toggle_leds_button_pressed();
}

void
DemoApp::update_gui(bool isConnected, bool isPressed, int potentiometerValue) {
  if(isConnected) {
