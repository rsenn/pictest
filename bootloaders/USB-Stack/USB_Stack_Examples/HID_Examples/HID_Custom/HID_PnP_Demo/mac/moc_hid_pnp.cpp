...
#define QT_MOC_LITERAL(idx, ofs, len)                                                                                  \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                                                             \
      len, qptrdiff(offsetof(qt_meta_stringdata_HID_PnP_t, stringdata0) + ofs - idx * sizeof(QByteArrayData)))
...
void
HID_PnP::qt_static_metacall(QObject* _o, QMetaObject::Call _c, int _id, void** _a) {
  if(_c == QMetaObject::InvokeMetaMethod) {
    auto* _t = static_cast<HID_PnP*>(_o);
    Q_UNUSED(_t)
    switch(_id) {
      case 0:
        _t->hid_comm_update((*reinterpret_cast<bool(*)>(_a[1])),
...
QT_INIT_METAOBJECT const QMetaObject HID_PnP::staticMetaObject = {{&QObject::staticMetaObject,
...
// SIGNAL 0
void
HID_PnP::hid_comm_update(bool _t1, bool _t2, int _t3) {
  void* _a[] = {nullptr,
