 ...
 * @date 13/02/2019
 *
 * USB uC - USB Application file (This file is for HID Keyboard + Consumer Example).
 ...
 */
bool
USB_ServiceClassRequest(void) {
  return HID_ClassRequest();
}
 ...
 */
bool
USB_GetClassDescriptor(void) {
  return HID_GetClassDescriptor();
}
 ...
 */
void
USB_AppClearHalt(uint8_t BDT_Index, uint8_t EP, uint8_t dir) {
  HID_ClearHalt(BDT_Index, EP, dir);
}
 ...
 *
 * Sets the Alternate Setting used for the specified Interface.
 *
