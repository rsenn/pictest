 ...
 * @date 13/02/2019
 *
 * HID RubberDucky Example (for PIC18F24K50/PIC18FX5K50).
...
void
SendKey(uint8_t Modifier, uint8_t KeyCode) {
...
void
SendConsumer(uint8_t Consumer_val) {
