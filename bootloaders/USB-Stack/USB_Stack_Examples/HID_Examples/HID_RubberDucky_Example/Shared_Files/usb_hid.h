...
const uint8_t HID_Report_Descriptor[] = {Usage_Page(GENERIC_DESKTOP_PAGE),
                                         Usage(KEYBOARD),
...
const uint16_t In_Report_Ptr[] = {(uint16_t)&In_Report1, (uint16_t)&In_Report2};

const uint8_t In_Report_Size[] = {HID_IN_REPORT1_SIZE, HID_IN_REPORT2_SIZE};
...
uint16_t Out_Report_Ptr[] = {(uint16_t)&Out_Report1};

uint8_t Out_Report_Size[] = {HID_OUT_REPORT1_SIZE};
