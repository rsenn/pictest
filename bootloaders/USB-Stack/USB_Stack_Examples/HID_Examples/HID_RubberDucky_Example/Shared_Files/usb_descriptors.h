...
const struct Config_Descriptor_Type Config_Descriptor0 = {
    ...
    // HID Descriptor
    {
        ...
        sizeof(HID_Report_Descriptor) // wDescriptorLength:16 - Size of HID report descriptor in bytes  // 0x003F
    },
...
const struct Vendor_String_Descriptor_Type Vendor_String_Descriptor = {sizeof(Vendor_String_Descriptor),
                                                                       STRING_DESC,
                                                                       {'J', 'o', 'h', 'n', 'n', 'y'}};

/** Product String Descriptor */
const struct Product_String_Descriptor_Type Product_String_Descriptor = {sizeof(Product_String_Descriptor),
                                                                         STRING_DESC,
                                                                         {'K', 'e', 'y', 'b', 'o', 'a', 'r', 'd'}};
