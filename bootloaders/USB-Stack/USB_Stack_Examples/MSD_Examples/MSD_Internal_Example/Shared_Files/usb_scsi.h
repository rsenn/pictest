...
// String Settings
#define SCSI_VENDER_ID                                                                                                 \
  { 'M', 'i', 'c', 'r', 'o', 'c', 'h', 'p' }
#define SCSI_PRODUCT_ID                                                                                                \
  { 'M', 'a', 's', 's', ' ', 'S', 't', 'o', 'r', 'a', 'g', 'e', ' ', ' ', ' ', ' ' }
#define SCSI_PRODUCT_REV                                                                                               \
  { '0', '0', '0', '1' }
...
const struct SCSI_Inquiry_Data_Type SCSI_Inquiry_Data = {
    {0x00,  // (7-5 Peripheral Qualifier) 0b000, (4-0 Peripheral Device Type) 0b00000: connected, SBC-4 direct block
            // access
     0x80,  // (7 RMB) 1, (6-0 Reserved): Removable
     0x04,  // (7-0) 0x04: Complies to ANSI INCITS 351-2001 (SPC-2)
     0x02,  // (7-6 Obsolete) 0, (5 NORMACA) 0, (4 HISUP) 0, (3-0 Response Data Format) 0b0010: not supported, not
            // supported, always two
