...
static __code char __at(_CONFIG1)
    configword1 = 0x3fff; //_FOSC_INTOSC & _WDTE_OFF & _PWRTE_ON & _MCLRE_OFF & _CP_OFF & _CPD_OFF & _BOREN_ON &
                          //_CLKOUTEN_OFF & _IESO_OFF & _FCMEN_OFF;
static __code char __at(_CONFIG2)
    configword2 = 0x3fff; //_FOSC_INTOSC & _WDTE_OFF & _PWRTE_ON & _MCLRE_OFF & _CP_OFF & _CPD_OFF & _BOREN_ON &
                          //_CLKOUTEN_OFF & _IESO_OFF & _FCMEN_OFF;
