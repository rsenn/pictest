...
# else
# define NUM_COMPARATORS 1
# endif
#else
#define NUM_COMPARATORS 0
#endif
...
#endif
#if PIC12 || defined(__18f25k22)
#define TOUTPS T2OUTPS
#define TOUTPS0 T2OUTPS0
#define TOUTPS1 T2OUTPS1
#define TOUTPS2 T2OUTPS2
#endif
#endif /* DEVICE_H */
