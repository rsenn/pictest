...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/serialtest_xc8.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../../../lib/adc.c ../../../lib/delay.c ../../../lib/ds18b20.c ../../../lib/lcd44780.c ../../../lib/ser.c ../../../lib/softser.c ../../../lib/timer.c ../../../lib/uart.c ../../../src/serialtest.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1386521430/adc.p1 ${OBJECTDIR}/_ext/1386521430/delay.p1 ${OBJECTDIR}/_ext/1386521430/ds18b20.p1 ${OBJECTDIR}/_ext/1386521430/lcd44780.p1 ${OBJECTDIR}/_ext/1386521430/ser.p1 ${OBJECTDIR}/_ext/1386521430/softser.p1 ${OBJECTDIR}/_ext/1386521430/timer.p1 ${OBJECTDIR}/_ext/1386521430/uart.p1 ${OBJECTDIR}/_ext/1386528437/serialtest.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1386521430/adc.p1.d ${OBJECTDIR}/_ext/1386521430/delay.p1.d ${OBJECTDIR}/_ext/1386521430/ds18b20.p1.d ${OBJECTDIR}/_ext/1386521430/lcd44780.p1.d ${OBJECTDIR}/_ext/1386521430/ser.p1.d ${OBJECTDIR}/_ext/1386521430/softser.p1.d ${OBJECTDIR}/_ext/1386521430/timer.p1.d ${OBJECTDIR}/_ext/1386521430/uart.p1.d ${OBJECTDIR}/_ext/1386528437/serialtest.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1386521430/adc.p1 ${OBJECTDIR}/_ext/1386521430/delay.p1 ${OBJECTDIR}/_ext/1386521430/ds18b20.p1 ${OBJECTDIR}/_ext/1386521430/lcd44780.p1 ${OBJECTDIR}/_ext/1386521430/ser.p1 ${OBJECTDIR}/_ext/1386521430/softser.p1 ${OBJECTDIR}/_ext/1386521430/timer.p1 ${OBJECTDIR}/_ext/1386521430/uart.p1 ${OBJECTDIR}/_ext/1386528437/serialtest.p1

# Source Files
SOURCEFILES=../../../lib/adc.c ../../../lib/delay.c ../../../lib/ds18b20.c ../../../lib/lcd44780.c ../../../lib/ser.c ../../../lib/softser.c ../../../lib/timer.c ../../../lib/uart.c ../../../src/serialtest.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/serialtest_xc8.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/serialtest_xc8.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/serialtest_xc8.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=none  --double=32 --float=24 --opt=default,+asm,-asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -DHAVE_UART=1 -D__DEBUG=1 -DUART_BAUD=38400 -DUSE_HD44780_LCD=1 -DUSE_SOFTSER=1 -DUSE_TIMER0=1 -DUSE_SER=1 -D_XTAL_FREQ=20000000 -D__16f876a=1 -DUSE_TIMER0=1 -DUSE_TIMER1=1 -P -N127 -I"../../.." -I"." -I"../../../lib" -I"../../../src" -V --warn=9 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,+oscval:0,-resetbits,+download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/serialtest_xc8.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/serialtest_xc8.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/serialtest_xc8.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/serialtest_xc8.X.${IMAGE_TYPE}.map  --double=32 --float=24 --opt=default,+asm,-asmfile,-speed,+space,-debug --addrqual=ignore --mode=pro -DHAVE_UART=1 -D__DEBUG=1 -DUART_BAUD=38400 -DUSE_HD44780_LCD=1 -DUSE_SOFTSER=1 -DUSE_TIMER0=1 -DUSE_SER=1 -D_XTAL_FREQ=20000000 -D__16f876a=1 -DUSE_TIMER0=1 -DUSE_TIMER1=1 -P -N127 -I"../../.." -I"." -I"../../../lib" -I"../../../src" -V --warn=9 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,+oscval:0,-resetbits,+download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/serialtest_xc8.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
