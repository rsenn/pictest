...
blinktest_SOURCES = blinktest.c lib/comparator.c lib/format.c lib/buffer.c lib/random.c lib/ser.c lib/softpwm.c lib/softser.c lib/timer.c lib/uart.c lib/delay.c lib/lcd5110.c lib/adc.c
blinktest_DEFS += -DUSE_TIMER0=1 -DUSE_TIMER1=1 -DUSE_SOFTPWM=1
blinktest_DEFS += -DUSE_SOFTSER=1 -DSOFTSER_TIMER=2 -DUSE_TIMER2=1
blinktest_DEFS += -DUSE_NOKIA5110_LCD=1 -DUSE_ADCONVERTER=1
