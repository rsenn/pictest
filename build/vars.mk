...
rgbtest_SOURCES = rgbtest.c lib/softpwm.c lib/timer.c lib/delay.c lib/random.c lib/uart.c
rgbtest_DEFS += -DUSE_TIMER0=1
#rgbtest_DEFS += -DUSE_TIMER1=1
rgbtest_DEFS += -DUSE_SOFTPWM=1 -DSOFTPWM_TIMER=0
rgbtest_DEFS += -DUSE_LED=1 -DUSE_UART=1 -DUART_BAUD=38400
