...
${OBJECTDIR}/_ext/1386528437/serialtest.p1: ../../../src/serialtest.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	@${RM} ${OBJECTDIR}/_ext/1386528437/serialtest.p1.d 
	@${RM} ${OBJECTDIR}/_ext/1386528437/serialtest.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none    --double=32 --float=32 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,+debug,-local --addrqual=ignore --mode=pro -D__18f25k50=1 -D_XTAL_FREQ=48000000 -DUART_BAUD=38400 -DUSE_TIMER0=1 -DUSE_TIMER1=1 -DUSE_TIMER2=1 -DUSE_SOFTPWM=1 -DUSE_SOFTSER=1 -DHAVE_COMPARATOR=1 -DDEBUG=1 -DUSE_SER=1 -P -N255 -I"../../.." -I"../../../lib" -I"../../../src" -v --warn=-3 --asmlist -DXPRJ_debug=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --codeoffset=0x2000 --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=+mcof,-elf:multilocs --stack=hybrid:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/1386528437/serialtest.p1 ../../../src/serialtest.c 
	@-${MV} ${OBJECTDIR}/_ext/1386528437/serialtest.d ${OBJECTDIR}/_ext/1386528437/serialtest.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/1386528437/serialtest.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
