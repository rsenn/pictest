...
${OBJECTDIR}/_ext/1386521430/pcd8544.p1: ../../../lib/pcd8544.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none    --double=32 --float=32 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=pro -D__18f16q41=1 -D_XTAL_FREQ=48000000 -DUART_BAUD=38400 -D_USE_TIMER0=1 -D_USE_TIMER1=1 -D_USE_TIMER2=1 -D_USE_SOFTPWM=1 -D_HAVE_COMPARATOR=1 -DNDEBUG=1 -D__XC8=1 -D_USE_SOFTSER=1 -DSOFTSER_TIMER=2 -DUSE_NOKIA5110_LCD=1 -D_USE_ADCONVERTER=1 -DXTAL_USED=NO_XTAL -DUSE_MCP3001=1 -P -N255 -I"../../.." -I"../../../lib" -I"../../../src" -I"../../../" --warn=0 --asmlist -DXPRJ_release=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,+keep,-no_startup,+download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=+mcof,-elf:multilocs --stack=hybrid:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/1386521430/pcd8544.p1 ../../../lib/pcd8544.c 
...
${OBJECTDIR}/_ext/1006914320/mcp3001.p1: /home/roman/Projects/pictest/lib/mcp3001.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none    --double=32 --float=32 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=pro -D__18f16q41=1 -D_XTAL_FREQ=48000000 -DUART_BAUD=38400 -D_USE_TIMER0=1 -D_USE_TIMER1=1 -D_USE_TIMER2=1 -D_USE_SOFTPWM=1 -D_HAVE_COMPARATOR=1 -DNDEBUG=1 -D__XC8=1 -D_USE_SOFTSER=1 -DSOFTSER_TIMER=2 -DUSE_NOKIA5110_LCD=1 -D_USE_ADCONVERTER=1 -DXTAL_USED=NO_XTAL -DUSE_MCP3001=1 -P -N255 -I"../../.." -I"../../../lib" -I"../../../src" -I"../../../" --warn=0 --asmlist -DXPRJ_release=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,+keep,-no_startup,+download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=+mcof,-elf:multilocs --stack=hybrid:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/1006914320/mcp3001.p1 /home/roman/Projects/pictest/lib/mcp3001.c 
...
${OBJECTDIR}/_ext/1386528437/blinktest.p1: ../../../src/blinktest.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1  --debugger=none    --double=32 --float=32 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=pro -D__18f16q41=1 -D_XTAL_FREQ=48000000 -DUART_BAUD=38400 -D_USE_TIMER0=1 -D_USE_TIMER1=1 -D_USE_TIMER2=1 -D_USE_SOFTPWM=1 -D_HAVE_COMPARATOR=1 -DNDEBUG=1 -D__XC8=1 -D_USE_SOFTSER=1 -DSOFTSER_TIMER=2 -DUSE_NOKIA5110_LCD=1 -D_USE_ADCONVERTER=1 -DXTAL_USED=NO_XTAL -DUSE_MCP3001=1 -P -N255 -I"../../.." -I"../../../lib" -I"../../../src" -I"../../../" --warn=0 --asmlist -DXPRJ_release=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,+keep,-no_startup,+download,+config,+clib,-plib $(COMPARISON_BUILD)  --output=+mcof,-elf:multilocs --stack=hybrid:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -o${OBJECTDIR}/_ext/1386528437/blinktest.p1 ../../../src/blinktest.c 
...
dist/${CND_CONF}/${IMAGE_TYPE}/blinktest_18f16q41_xc8.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/blinktest_18f16q41_xc8.X.${IMAGE_TYPE}.map  -D__DEBUG=1  --debugger=none  -DXPRJ_release=$(CND_CONF)    --double=32 --float=32 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=pro -D__18f16q41=1 -D_XTAL_FREQ=48000000 -DUART_BAUD=38400 -D_USE_TIMER0=1 -D_USE_TIMER1=1 -D_USE_TIMER2=1 -D_USE_SOFTPWM=1 -D_HAVE_COMPARATOR=1 -DNDEBUG=1 -D__XC8=1 -D_USE_SOFTSER=1 -DSOFTSER_TIMER=2 -DUSE_NOKIA5110_LCD=1 -D_USE_ADCONVERTER=1 -DXTAL_USED=NO_XTAL -DUSE_MCP3001=1 -P -N255 -I"../../.." -I"../../../lib" -I"../../../src" -I"../../../" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,+keep,-no_startup,+download,+config,+clib,-plib --output=+mcof,-elf:multilocs --stack=hybrid:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/blinktest_18f16q41_xc8.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/blinktest_18f16q41_xc8.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/blinktest_18f16q41_xc8.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/blinktest_18f16q41_xc8.X.${IMAGE_TYPE}.map  -DXPRJ_release=$(CND_CONF)    --double=32 --float=32 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=pro -D__18f16q41=1 -D_XTAL_FREQ=48000000 -DUART_BAUD=38400 -D_USE_TIMER0=1 -D_USE_TIMER1=1 -D_USE_TIMER2=1 -D_USE_SOFTPWM=1 -D_HAVE_COMPARATOR=1 -DNDEBUG=1 -D__XC8=1 -D_USE_SOFTSER=1 -DSOFTSER_TIMER=2 -DUSE_NOKIA5110_LCD=1 -D_USE_ADCONVERTER=1 -DXTAL_USED=NO_XTAL -DUSE_MCP3001=1 -P -N255 -I"../../.." -I"../../../lib" -I"../../../src" -I"../../../" --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,+keep,-no_startup,+download,+config,+clib,-plib --output=+mcof,-elf:multilocs --stack=hybrid:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/blinktest_18f16q41_xc8.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
